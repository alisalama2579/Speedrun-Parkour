...
[CreateAssetMenu(fileName = "PlayerBurrowMovementStats", menuName = "ScriptableObjects/Player/PlayerBurrowMovementStats")]
public class BurrowMovementStats : ScriptableObject
{
    ...
    [Header("Dash")]
    #region Dash
    public float entryDashSpeed;

    public float dashSlownessAcummulation;
    public float dashSlownessDecay;
    ...
    public AnimationCurve entryDashSpeedCurve;
